...
TitleText.Font = Enum.Font.SourceSansBold
	local title = getgenv().AuthGuardSettings.Script_Title or "Key System"
	TitleText.Text = title
	if getgenv().AuthGuardSettings.Script_Title == "SCRIPT_TITLE" or "" then TitleText.Text = "Key System" end
	...
	DescriptionText.Text = "By completing a quick checkpoint, you will receive a " .. tonumber(getgenv().AuthGuardSettings.KEY_EXPIRATION or 24) .. "-hour key."
local value = getgenv().AuthGuardSettings.KEY_EXPIRATION
	if tonumber(value) == nil then
	DescriptionText.Text = "By completing a quick checkpoint, you will receive a 24-hour key."
	end
	...
	_1ATextKey.Font = Enum.Font.SourceSansBold
	_1ATextKey.Text = ""
	...
	_2BConfirmKey.Font = Enum.Font.SourceSansBold
	_2BConfirmKey.Text = ""
	...
	_3CTextLabel.Font = Enum.Font.SourceSansBold
	...
	DiscordButton.Position = UDim2.new(0.484189719, 0, 0.46, 0)
	...
	CheckPoint1.Font = Enum.Font.SourceSansBold
	CheckPoint1.Text = ""
	...
	Checkpoint1Text.Font = Enum.Font.SourceSansBold
	...
	CheckPoint2.Font = Enum.Font.SourceSansBold
	CheckPoint2.Text = ""
	...
	Checkpoint2Text.Font = Enum.Font.SourceSansBold
	...
	if getgenv().AuthGuardSettings.INVITE_CODE == "" then 
		getgenv().AuthGuardSettings.INVITE_CODE = "sHU3jFKUVc"
	end
		clickCount += 1
	setclipboard("https://discord.gg/" .. getgenv().AuthGuardSettings.INVITE_CODE or "sHU3jFKUVc")
			...
			httprequest(
				{
					...
					Body = HttpService:JSONEncode(
						...
						args = {code = getgenv().AuthGuardSettings.INVITE_CODE or "sHU3jFKUVc"}
						}
					)
				}
			)
